...
const validateTaskForm = () => {
   if(taskName.value === ""){
    ...
    taskHeaderError.innerText = 'Task name needs to be longer than 8 characters.'
   };
   if (taskDescription.value === ""){
    taskDescriptionError.innerText = 'Please add a task description.'
   } else if (taskDescription.value.length < 15){
    taskDescriptionError.innerText = 'Task Description needs to be longer than 15 characters.'
   };
   if(taskAssign.value === ""){
